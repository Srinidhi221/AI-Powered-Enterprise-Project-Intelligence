...
"""
app/agents/llm_client.py
Thin wrapper around Groq's API (OpenAI-compatible protocol) used by every
Milestone 2 agent. Groq's free tier requires no billing setup and is not
subject to the aggressive per-model quota changes seen on other providers.
"""
...
from app.config import GROQ_API_KEY, GROQ_MODEL, AGENT_TEMPERATURE
